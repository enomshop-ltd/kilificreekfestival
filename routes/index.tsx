  ...
  return (
    <div class="px-4 py-8 mx-auto fresh-gradient min-h-screen">
      <div class="h-24 z-50 relative container mx-auto px-6 grid grid-cols-3">
        ...
        <div class="flex items-center justify-center"><a href="index.html"
                class="text-white uppercase font-bold text-2xl tracking-widest">Kilifi Creek Festival</a></div>
        <div class="flex items-center justify-end"><a href="contact/index.html"><svg class="w-8 h-8 text-white"
                    fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
